...
insert into usuario (id, nome, email, senha, data_cadastro) values (5, 'Luan Pineiro', 'luan@gmail.com', 'admin', current_timestamp);
insert into usuario (id, nome, email, senha, data_cadastro) values (6, 'Eduarva Tavares', 'eduarda.tvrs2108@gmail.com', 'admin', current_timestamp);
insert into usuario (id, nome, email, senha, data_cadastro) values (7, 'Luan Pineiro da Silva', 'comjoao.ger@algafood.com', 'admin', current_timestamp);
